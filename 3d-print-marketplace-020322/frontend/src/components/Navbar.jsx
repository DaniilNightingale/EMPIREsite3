      ...
      <nav className="nav shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex justify-between items-center h-14 sm:h-16 relative">
            ...
            {/* Мобильная кнопка меню - слева на мобильных устройствах */}
            <button
            ...
            {/* Кнопка выхода - справа на мобильных устройствах */}
            <button
              className="md:hidden btn btn-ghost text-white hover:bg-gray-800 text-xs px-2 py-1"
              onClick={() => {
            ...
            {/* Десктопная навигация и информация о пользователе */}
            ...
            {/* Дополнительные десктопные элементы */}
            <div className="hidden md:flex items-center gap-2">
              {/* Уведомления */}
